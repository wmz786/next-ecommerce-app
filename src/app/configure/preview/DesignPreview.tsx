...
const DesignPreview = ({ configuration }: { configuration: Configuration }) => {
  ...
  const [isLoggedModelOpen, setIsLoggedModelOpen] = useState<boolean>(false);
  ...
  return (
    <>
      ...
      <LoginModal isOpen={isLoggedModelOpen} setIsOpen={setIsLoggedModelOpen} />
